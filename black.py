...
print '-----://::/++oooooooooooosssoosoyo  ``   ``   ``   ``   ```  ```  ```  ```  ``` '
print ' ````.--::-:+/:://:---::-............--........--::yo``  ```  ```  ```  ```  ```   ``   ``   ``   `'
print '::::-:-.`..`   ``   ```  ```  ```  ``` `-:://+oooosyoy. ``   ``   ``   ``   ``   ```  ```  ```  ``` '
print '  ```  ```  ```  ```   ``   ``  .-::++sso+++/:/::-...ss-  ```  ``..-::.  ```  ```   ``   ``   ``   `'
print '  ``   ``   ``   ``   ```  ``-:/+o+/::--` ```  ```  ```-yyo:.  ``   ````-///.````  ```  ```  ```  ```' 
print '  `   ``   ```  ``   ``.-/++::-```  ```  ```  ```  ``` :yyyyyso+///:-.` ```:++:`  ```  ```  ```  ```' 
print '    ```  ```  ```  `-://:-.   ``   ``   ``   ``   ```  ./syyyyyhhhhhhhhhyo/:-``-+o:`  ``   ``   ``  `'
print '  ``   ``   `` `.:/:-````  ```  ```  ```  ```  ```  `.+yyyyyo/::---:++oyhddddyoy- /so.  ```  ```  ```' 
print '   ```  ```.:/:-` ```  ```  ```   ``   ``   ``   ``/yyyy+-````  ```  ````-/shdmdyhhoss.   ``   ``  `'
print '  `   ``  `-`   ``   ```  ```  ```  ```  ```  ````oysyo. ``   ``   ``   ``   .:+sdmmyyy-``  ```  ```' 
print '  `   ``   ``   ``   ```  ``   ```  ```  ```  ```ossy+`  ``   ``   ```  ``   ``` `-mmmmmo`  ```  ```' 
print '   ```  ```  ```  ```   ``   ``   ``   ``   ``  -ssso ```  ```  ```  ```  ```  ``` odmmmNs``   ``   `'
print '  ``   ``   ``   ``   ```  ```  ```  ```  ```  ``osss/`   ``   ``   ``   ```  ```  ```-+hmms-```  ```' 
...
print '  ``   ``   ``   ``   ```  ```  ```  ```  ```  ```  /yyyyo:.   ``   ``   ``   ```  ```  ```  ```  ```' 
print '    ```  ```  ```  ```  ```  ```   ``   ``   ``   ```./syyyys+/:..``  ```  ```  ```   ``   ``   ``   `'
print '    ```  ```  ```  ```  ```  ```  ```   ``   ``   ```  `-/oyyyyhhhhhyooso//:-.`````  ```  ```   ```  `'
print '  ``   ``   ``   ``   ```  ```  ```  ```  ```  ```  ```   ```.:/+ooosyhhhdddddddhss+/-.````  ```  ```' 
print '    ```  ```  ```  ```   ``   ``   ``   ``   ``   ```  ```  ```  ```  ``..-/oyhmmmmhhdmdhs/-`   ``   ` '
print '  `   ``   ``   ``   ```  ```  ```  ```  ```  ```  ```   ``   ``   ``   ``   `-+hmmh/.-/sdNds:`  ``` ' 
print '  ```  ```  ```  ```  ```  ```   ``   ``   ``   ```  ```  ```  ```  ```  ```  ``-ommd+`  ./ymd/``  ` '
print '   ```  ```  ```  ```  ```  ```   ``   ``   ``   ```  ```  ```  ```  ```  ```  ``` .odmm+``` `/hd:  ` '
print '  ``   ``   ``   ``   ```  ```  ```  ```  ```  ```  ```   ``   ``   ``   ``   ```  ````/dNh- ``` -hy. ' 
